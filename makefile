...
bin/gofish: build/main.o build/deck.o build/game.o build/stack.o build/bot.o
	$(CC) build/main.o build/deck.o build/game.o build/stack.o build/bot.o -o bin/gofish

build/main.o: src/main.c src/game.h src/deck.h src/stack.h
